package com.example.user.swipelistenerrecycler.waste;
...
public class FirstActivity extends AppCompatActivity implements RecyclerItemTouchHelper.RecyclerItemTouchHelperListener {
